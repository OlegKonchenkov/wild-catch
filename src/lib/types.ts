...
export type EquipmentSlot = 'arma' | 'corazza' | 'elmo' | 'accessorio'
export type ItemType = 'rete' | 'esca' | 'uovo' | 'battaglia' | 'pozione' | 'cura' | 'chiave' | EquipmentSlot
export type QRCodeType = 'uovo' | 'indizio' | 'oggetto' | 'boss' | 'evento' | 'creatura' | 'bustina' | 'forziere' | 'gemme' | 'premio'
