  ...
  return (
    <div className="fixed inset-0 z-[1200] flex flex-col items-center justify-center overflow-hidden"
      ...
      <motion.div aria-hidden className="absolute pointer-events-none rounded-full"
        style={{ width: 460, height: 460, background: `radial-gradient(circle, ${accent}22 0%, transparent 68%)` }}
        animate={{ scale: phase === 'reveal' ? [1, 1.15, 1] : 1, opacity: phase === 'locked' ? 0.5 : 0.9 }}
