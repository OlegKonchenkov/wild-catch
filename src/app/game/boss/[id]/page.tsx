...
const ELEMENT_THEME: Record<
  string,
  { bg: string; glow: string; ground: string }
> = {
...
function CreatureCard({
  ...
  const spriteSize =
    typeof window !== "undefined"
      ? Math.round(
          Math.min(window.innerWidth * 0.35, window.innerHeight * 0.2, 158),
        )
      : 122;
  const imageWidth = spriteSize + 10;
  const rarityColor = isBoss
    ? "#F7C841"
    : (RARITY_COLORS[rarity as Rarity] ?? "#64748b");
    ...
    >
      ...
      <div className="flex-1 px-3 py-2.5 flex flex-col justify-between min-w-0">
        ...
        <div>
          ...
          {statusEffect &&
            STATUS_EFFECT_META[statusEffect] &&
            (() => {
                ...
                <div className="mt-1.5">
                  ...
                  >
                    ...
                    {statusTurnsLeft != null && statusTurnsLeft > 0 && (
                      <span className="opacity-50 text-[9px] font-bold ml-0.5">
                        ×{statusTurnsLeft}
                      </span>
                    )}
                  </motion.span>
        ...
        {atk !== undefined && (
          <div className="flex items-center gap-1.5 mt-1">
            ...
            <span
              ...
              style={{ color: isBoss ? "#F7C841" : "#E85D2F" }}
            >
              {atk}
            </span>
          </div>
        ...
        <div className="mt-1.5">
          <div
            className="h-[7px] rounded-full overflow-hidden mb-[3px]"
...
function formatFortuneText(
  fortune: CombatFortuneInfo | null | undefined,
): string | null {
